...
export class CourseSeeder {
    ...
    async seed() {
        ...
        const webModule1 = await this.moduleModel.create({
            ...
            order: 1,
            contents: [
                { type: 'video', url: 'https://example.com/videos/html-basics.mp4', title: 'HTML Basics' },
                { type: 'pdf', url: 'https://example.com/docs/html-guide.pdf', title: 'HTML Reference Guide' },
                { type: 'video', url: 'https://example.com/videos/css-intro.mp4', title: 'CSS Introduction' },
            ],
        });
        ...
        const webModule2 = await this.moduleModel.create({
            ...
            order: 2,
            contents: [
                { type: 'video', url: 'https://example.com/videos/js-basics.mp4', title: 'JavaScript Basics' },
                { type: 'pdf', url: 'https://example.com/docs/js-guide.pdf', title: 'JavaScript Guide' },
            ],
        });
        ...
        const dsModule1 = await this.moduleModel.create({
            ...
            order: 1,
            contents: [
                { type: 'video', url: 'https://example.com/videos/python-intro.mp4', title: 'Python Introduction' },
                { type: 'pdf', url: 'https://example.com/docs/numpy-pandas.pdf', title: 'NumPy & Pandas Guide' },
            ],
        });
