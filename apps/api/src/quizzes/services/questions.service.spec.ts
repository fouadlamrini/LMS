...
describe('QuestionsService', () => {
    ...
    describe('validateQuestion', () => {
        it('should throw if TRUE_FALSE has options', async () => {
            ...
            await expect(service.addQuestion(mockQuizId, dto as any))
        ...
        it('should throw if MULTIPLE_CHOICE has multiple correct options', async () => {
            ...
            await expect(service.addQuestion(mockQuizId, dto as any))
                .rejects.toThrow('Multiple choice questions must have exactly one correct option');
        });
        ...
        it('should throw if MULTIPLE_SELECT has no correct options', async () => {
            ...
            await expect(service.addQuestion(mockQuizId, dto as any))
                .rejects.toThrow('Multiple select questions must have at least one correct option');
        });
        ...
        it('should throw if SHORT_ANSWER missing correctAnswerText', async () => {
            ...
            await expect(service.addQuestion(mockQuizId, dto as any))
                .rejects.toThrow('Short answer questions require correctAnswerText');
        });
        ...
        it('should throw if choice question has text/boolean answers', async () => {
            ...
            await expect(service.addQuestion(mockQuizId, dto as any))
                .rejects.toThrow('Choice questions must not have text or boolean answers');
        });
    });
    ...
    describe('addQuestion', () => {
        it('should add question & update passing score', async () => {
            ...
            expect(quizzesService.getDefaultPassingScore).toHaveBeenCalledWith(mockQuiz);
    ...
    describe('updateQuestion', () => {
        it('should throw if quiz does not exist', async () => {
            jest.spyOn(quizzesService, 'findOne').mockRejectedValue(new NotFoundException());

            await expect(service.updateQuestion(mockQuizId, mockQuestionId, {}))
        ...
        it('should update question & save', async () => {
            ...
            await service.updateQuestion(mockQuizId, mockQuestionId, { text: 'Updated' });
    ...
    describe('removeQuestion', () => {
        ...
        it('should throw if question missing', async () => {
            ...
            await expect(service.removeQuestion(mockQuizId, mockQuestionId))
                .rejects.toThrow(NotFoundException);
        });
    });
    ...
    describe('getQuestion', () => {
        ...
        it('should throw if quiz missing', async () => {
            ...
            await expect(service.getQuestion(mockQuizId, mockQuestionId))
                .rejects.toThrow(NotFoundException);
        });
    });
});
